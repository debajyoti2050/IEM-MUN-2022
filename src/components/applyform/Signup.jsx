...
export const Signup = () => {
  ...
  const validate = Yup.object({
    ...
    organization: Yup.string()
      ...
      .required('Required'),
    organization2: Yup.string().max(100, 'Must be 100 characters or less'),
    ...
    referId: Yup.string().max(10, 'Must be 10 characters or less'),
  })
      ...
      {loading ? (
        ...
        <Formik
          ...
          onSubmit={async (values) => {
            ...
            try {
              await axios.post(
                'https://cema-mun.herokuapp.com/api/register/',
                values
              )
              setLoading(false)
              ...
              <Form>
                ...
                <div className='copref'>
                  ...
                  <label>
                    ...
                    &nbsp;&nbsp;INTERNATIONAL PRESS (IP) &nbsp;&nbsp; (No
                    profiles, write NA in country preferences)
                  </label>
                  <br />
